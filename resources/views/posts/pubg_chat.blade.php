...
<html lang="{{ str_replace("_", "-", app()->getLocale()) }}">
    ...
    <body>
        <div class="chat-body">
            <h2 class="title">
                <?php if($pubg->rank == 'free'):?>
                    <p>PLAYERUNKNOWN'S BATTLEGROUNDS：{{$pubg->rank}}chat</p>
                <?php else: ?>
                    <p>PLAYERUNKNOWN'S BATTLEGROUNDS：{{$pubg->rank}}帯掲示板</p>
                <?php endif; ?>
            </h2>
            ...
            <div class="contents-body">
                <div class="contents">
                    <div class="content__post">
                        ...
                        @foreach($comments as $comment)
                            <!--freechat-->
                            <?php if (($comment->game_id == 3) && ($pubg->id == 9)):?>
                                <div class="rank-chat">
                                    <?php if(($comment->user->name) == (Auth::user()->name)) :?>
                                        <a href="/posts/mypage">{{$comment->user->name}}</a>
                                    <?php else: ?>
                                        <a href="/posts_userpage/{{$comment->id}}">{{$comment->user->name}}</a><br>
                        　　          <?php endif; ?>
                                ...
                                　　 <!--replyフォーム-->
                                    <div class="reply">
                                        <?php if(Auth::user()->pubg_rank >= ($comment->user->pubg_rank)):?>
                                                ...
                                                <div class="reply-content">
                                                    <form action="/posts_reply" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="body">
                                                            ...
                                                            <div class="body">
                                                                <textarea name="replies[body]" placeholder="PUBG Comment." cols="50" rows="5">{{old('replies.body')}}</textarea>
                            ...
                            <!--freechat以外-->
                            <?php elseif (($comment->game_id == 3)  &&  (($comment->user->pubg_rank) <= ($pubg->id))): ?>
                                <div class="rank-chat">     
                                    <?php if(($comment->user->name) == (Auth::user()->name)) :?>
                        ...
                        　　          <?php endif; ?>
                                ...
                                　　<div class="row justify-content-center">
                                    ...
                                    <!--replyフォーム-->
                                    <div class="reply">
                                        <?php if(Auth::user()->pubg_rank <= ($pubg->id)):?>
                                            <div class="wrap reply-btn">
                                                <label for="label_reply{{$reply_num}}" class="btn btn-info">reply</label>
                                                <input type="checkbox" id="label_reply{{$reply_num}}" class="switch_reply" />
                                                <div class="reply-content">
                ...
                <!--コメント書き込みフォーム-->
                <div class="comment">
                    <?php if((Auth::user()->pubg_rank == 100) && ($pubg->id == 9)):?>
                        ...
                        <div class="body">
                            ...
                            <div class="body">
                                <textarea name="comments[body]" placeholder="PUBG Comment." cols="60" rows="6">{{old('comments.body')}}</textarea>
                    ...
                    <?php elseif(Auth::user()->pubg_rank <= ($pubg->id)):?>
                        <form action="/posts" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="body">
                            <h3>comment書き込み</h3>
